...
<body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('/images/234img.jpg');">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 bread">Time Table</h1>
            ...
            <div class="row mb-5">
                    ...
                    <div class="ftco-footer-widget mb-5">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><span><img src="/images/call.png"></span><span class="text">0718765342</span></a>
                                </li>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="ftco-footer-widget mb-5 ml-md-4">
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active"><a href="{{ url('home-old') }}" class="nav-link pl-0">Home</a>
                            </li>
                            <li class="nav-item active"><a href="{{url ('about') }}" class="nav-link">About</a></li>
                            <li class="nav-item active"><a href="{{ url('teacher') }}" class="nav-link">Teachers</a>
                            </li>
                            <li class="nav-item active"><a href="{{ url('news-website') }}" class="nav-link">news</a>
                            </li>
                            <li class="nav-item active"><a href="{{ url('timetable-interface') }}" class="nav-link">Time
                                    Table</a></li>
                        </ul>
